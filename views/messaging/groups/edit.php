        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><?= htmlspecialchars($group['name']) ?></h3>
                </div>
                <div class="card-body">
                    ...
                    <form method="post" action="index.php?action=messaging&do=groups_update">
                        ...
                        <div class="form-group">
                            ...
                            <div style="max-height:300px; overflow:auto; border:1px solid #eee; padding:10px;">
                                <?php $memberSet = array_flip($members ?: []); foreach ($users as $u): ?>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="members[]" value="<?= $u['id'] ?>" id="user_<?= $u['id'] ?>" <?= isset($memberSet[$u['id']]) ? 'checked' : '' ?> >
