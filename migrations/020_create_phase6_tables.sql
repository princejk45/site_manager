...
CREATE TABLE IF NOT EXISTS `automation_workflows` (
    ...
    CONSTRAINT fk_automation_workflows_portfolio FOREIGN KEY (portfolio_id) REFERENCES portfolios(id) ON DELETE CASCADE,
    CONSTRAINT fk_automation_workflows_created_by FOREIGN KEY (created_by) REFERENCES users(id),
...
CREATE TABLE IF NOT EXISTS `automation_templates` (
    ...
    `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    `updated_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_automation_templates_created_by FOREIGN KEY (created_by) REFERENCES users(id),
...
CREATE TABLE IF NOT EXISTS `automation_executions` (
    ...
    CONSTRAINT fk_automation_executions_workflow FOREIGN KEY (workflow_id) REFERENCES automation_workflows(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS `automation_execution_logs` (
    ...
    CONSTRAINT fk_automation_execution_logs_execution FOREIGN KEY (execution_id) REFERENCES automation_executions(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS `user_sso_accounts` (
    ...
    `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    `updated_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_user_sso_accounts_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS `email_templates` (
    ...
    `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    `updated_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_email_templates_portfolio FOREIGN KEY (portfolio_id) REFERENCES portfolios(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS `email_template_versions` (
    ...
    CONSTRAINT fk_email_template_versions_changed_by FOREIGN KEY (changed_by) REFERENCES users(id),
...
CREATE TABLE IF NOT EXISTS `tenant_settings` (
    ...
    `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    `updated_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_tenant_settings_portfolio FOREIGN KEY (portfolio_id) REFERENCES portfolios(id) ON DELETE CASCADE,
    INDEX idx_portfolio_id (portfolio_id),
...
CREATE TABLE IF NOT EXISTS `tenant_usage` (
    ...
    `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    `updated_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_tenant_usage_portfolio FOREIGN KEY (portfolio_id) REFERENCES portfolios(id) ON DELETE CASCADE,
